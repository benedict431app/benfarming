...
class Config:
    ...
    # Contact Information
    CONTACT_PHONE = "+254713593573"
    CONTACT_WHATSAPP = "+254713593573"
    CONTACT_EMAIL = os.getenv('CONTACT_EMAIL', 'support@benfarming.com')
    ...
    PLANT_DETECTION_THRESHOLD = 0.3  # Confidence threshold for plant detection
